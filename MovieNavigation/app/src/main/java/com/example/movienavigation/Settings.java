    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                ...
                break;
            case R.id.nav_add:
                Intent a= new Intent(Settings.this,AddMovieActivity.class);
                startActivity(a);
                break;
            case R.id.nav_fav:
                Intent f= new Intent(Settings.this,Favorites.class);
                startActivity(f);
                break;
            case R.id.nav_wishlist:
                Intent w= new Intent(Settings.this,WishList.class);
                startActivity(w);
                break;
            case R.id.nav_tvshows:
                Intent t= new Intent(Settings.this,TvShows.class);
                startActivity(t);

                break;
            case R.id.nav_recent:
                Intent r= new Intent(Settings.this,RecentMovies.class);
                startActivity(r);
            ...
            case R.id.nav_settings:
                ...
                break;
            case R.id.nav_help:
                Intent h= new Intent(Settings.this,Help.class);
                startActivity(h);
