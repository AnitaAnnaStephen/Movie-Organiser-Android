...
public class Favorites extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.add_movies:
                //movieViewModel.deleteAllMovies();
                Intent intent=new Intent(Favorites.this,AddMovieActivity.class);
                startActivityForResult(intent,ADD_MOVIE_REQUEST);
                Toast.makeText(this, "Add movies ", Toast.LENGTH_SHORT).show();
                return true;
            default:
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent m= new Intent(Favorites.this,MainActivity.class);
                startActivity(m);
                break;
            case R.id.nav_add:
                Intent a= new Intent(Favorites.this,AddMovieActivity.class);
                startActivity(a);
                break;
            case R.id.nav_fav:
                Intent f= new Intent(Favorites.this,Favorites.class);
                startActivity(f);
                break;
            case R.id.nav_wishlist:
                Intent w= new Intent(Favorites.this,WishList.class);
                startActivity(w);
                break;
            case R.id.nav_tvshows:
                Intent t= new Intent(Favorites.this,TvShows.class);
                startActivity(t);

                break;
            case R.id.nav_recent:
                Intent r= new Intent(Favorites.this,RecentMovies.class);
                startActivity(r);

                break;
            case R.id.nav_settings:
                Intent s= new Intent(Favorites.this,Settings.class);
                startActivity(s);

                break;
            case R.id.nav_help:
                Intent h= new Intent(Favorites.this,Help.class);
                startActivity(h);
